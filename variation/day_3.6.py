# Day 3.6: Wordverse Game - Sentence Builder Main Frame
# In this Code Snippet, we remove the dummy data and implement the logic to take and shuffle sentences from the JSON file.
# We will also implement the logic to check the sentence and give feedback to the user.
...
class WordverseGame:
    ...
    def setup_sentence_builder(self):
        ...
        submit_btn = ctk.CTkButton( control_frame, text="✅ Check Sentence", font=(self.font, 18, "bold"),command=self.check_sentence, 
