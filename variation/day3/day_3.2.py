# Day 3.2: Wordverse Game - Sentence Builder Main Frame
# In this Code Snippet, we will continue building the Sentence Builder game interface
# We will Add Dummy data for testing UI
