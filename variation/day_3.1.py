# Day 3.1: Wordverse Game - Sentence Builder Main Frame
# In this Code Snippet, we will create the sentence builder main frame.
...
class WordverseGame:
    ...
    def setup_sentence_builder(self):
        ...
        # Game frame
        self.game_frame = ctk.CTkFrame(self.root, fg_color=("#1a1a2e", "#0f0f1a"))
        self.game_frame.pack(fill="both", expand=True)
