# Day 2.5 Wordverse Game - Word Scramble Mode
# In this game, the computer picks a word, mixes up its letters, and you have to guess what the word is!
# We use random module to choose a word from a list, scramble it, and let you try to solve it.


# Task 1 : When we submit the answer, if it wrong or correct, we should get a message.but there is no label to show the message.
#          Your Task is to add a label at the bottom of the game window self.feedback_label at line number 259 and give your own design.
